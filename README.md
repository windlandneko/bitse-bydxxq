...
![运营大屏](docs/screenshots/ui-polish/dashboard-1920.png)
...
- [界面设计规范](docs/界面设计规范.md) / [界面精修验收](docs/界面精修验收.md)：Material与开源Android布局参考、量化规则和两端截图。
...
不能作为真实电网调度精度承诺。大屏边框的 MIT 许可及 Lucide 图标的 ISC 许可随源码保留。
